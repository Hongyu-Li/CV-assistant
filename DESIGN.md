...
- **Primary Teal** (#2BA8A2): Main UI, avatars, progress bars, focus rings
- **Primary Light** (#3CC4BD): CTAs, hover states, accent buttons
- **Primary Dark** (#1E8C86): Text on light surfaces
- **Accent Gold** (#FFD23F): Highlights, first-player badges, celebrations, warnings
- **Accent Light** (#FFE47A): Soft gold tints, active states
- **Accent Dark** (#E6B800): Gold hover states, depth
- **Coral** (#EF6C4A): BOOM state, destructive actions, ranking #3, energy
- **Coral Light** (#FF8A6A): Soft coral tints
- **Coral Dark** (#D45233): Coral depth, hover
- **Sky Blue** (#5DADE2): Flip7 bonus, info states
- **Surface Base**: Neutral near-white (light) / near-black (dark) — no teal tint
- **Surface Card**: Pure white (light) / neutral dark gray (dark)
- **Border**: Neutral gray — no teal tint
...
- Primary Light teal (#3CC4BD) background, gloss overlay via ::before
- Shadow: shadow-teal-glow, Active: scale(0.95)
